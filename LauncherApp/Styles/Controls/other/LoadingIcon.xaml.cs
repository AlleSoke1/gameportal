...
namespace LauncherApp.Styles.Controls
{
    ...
    public partial class LoadingIcon
    {
        public static readonly DependencyProperty MinimumProperty =
            DependencyProperty.Register("Minimum", typeof(int), typeof(LoadingIcon), new UIPropertyMetadata(1));

        public static readonly DependencyProperty MaximumProperty =
            DependencyProperty.Register("Maximum", typeof(int), typeof(LoadingIcon), new UIPropertyMetadata(1));

        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register("Value", typeof(int), typeof(LoadingIcon), new UIPropertyMetadata(100));
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoadingIcon"/> class.
        /// </summary>
        public LoadingIcon()
        {
            InitializeComponent();
